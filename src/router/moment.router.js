...
const { create, detail, list, update, remove, addLabels, getPictureByFilename } = require('../controller/moment.controller')
...
router.get('/images/:filename', getPictureByFilename)
